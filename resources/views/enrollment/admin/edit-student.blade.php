...
@section('content')
        ...
        <div class="row">
            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 offset-2">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal" id="editStudentForm" action="{{ url('/update-student') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input name="student_id" value="{!! $students->student_id !!}" type="number" class="form-control">
                                    <span style="color: red"> {{ $errors->has('service_name') ? $errors->first('service_name') : ' ' }}</span>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    ...
                                    <img src="{!! asset('student-images/'.$students->image) !!}" height="90" width="90"/>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-4 col-sm-12">
                                    <button type="submit" name="btn" class="btn btn-block btn-success">Update Student</button>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <script>
        document.forms['editStudentForm'].elements['department_id'].value="{!! $students->department_id !!}";
    </script>
@endsection